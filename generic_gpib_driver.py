...
DEFAULT_GPIBCMD_DIR = "C:/Users/chuckyin/factory-test/bin/CmdGpib"
...
if __name__ == '__main__':
    POWER_SUPPLY = GpibInstrument("PS", command_files_directory="c:/Users/chuckyin/factory-test/data", debug_mode=False)
    print (POWER_SUPPLY.send_commands_from_file("OutputOn.txt"))

    MUX = GpibInstrument("MUX", command_files_directory="c:/Users/chuckyin/factory-test/data", debug_mode=False)
